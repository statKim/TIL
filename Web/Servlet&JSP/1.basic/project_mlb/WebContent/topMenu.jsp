...
<header>
	...
	<c:if test="${not empty sessionScope.sid}"> <%-- sid 값이 있으면 로그인 된 상태 --%>
		...
		<a href="#">| 이벤트 </a>
		<a href="#">| 고객센터 </a>
		<a href="jsp/newMember.jsp">| 회원가입</a>
	</div>
</header>
...
<nav>
	...
	<div id="subMenuBox">
		<div class="subMenuItem" id="subMenuItem1">
			<ul>
				<li><a href="jsp/1-1.jsp">선수별 조회</a></li>
				<li><a href="jsp/1-2.jsp">기록별 조회</a></li>    			             
			</ul>
		</div>
		<div class="subMenuItem" id="subMenuItem2">
			<ul>
				<li><a href="jsp/2-1.jsp">선수별 조회</a></li>
				<li><a href="jsp/2-2.jsp">기록별 조회</a></li>      			             
			</ul>
		</div> 
