...
(function (t, n) {
    ...
    function be(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);)
            if (!(t = t.parentNode)) return Qp.time = dn(), Qp;
        return e
    }
    ...
    var Ls = function (t, n) {
        ...
        Bs = function (t, n) {
            var e, r, i = t.length,
                ...
                c = 0;
            if (null == n)
                for (; ++a < i;) isNaN(e = Ys(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else
                for (; ++a < i;) isNaN(e = Ys(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1) return u / (c - 1)
        },
        js = function (t, n) {
            var e = Bs(t, n);
        ...
        cf = function (t, n) {
            var e, r = 0,
                ...
                u = i;
            if (null == n)
                for (; ++o < i;) isNaN(e = Ys(t[o])) ? --u : r += e;
            else
                for (; ++o < i;) isNaN(e = Ys(n(t[o], o, t))) ? --u : r += e;
            if (u) return r / u
        },
        sf = function (t, n) {
            var e, r = [],
                ...
                o = -1;
            if (null == n)
                for (; ++o < i;) isNaN(e = Ys(t[o])) || r.push(e);
            else
                for (; ++o < i;) isNaN(e = Ys(n(t[o], o, t))) || r.push(e);
    ...
    var bl = function (t) {
        ...
        Ml = function (t, n, e) {
            ...
            for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)
                if ((r = n[i]).identifier === e) return Of(t, r);
            return null
        },
        Tl = function (t, n) {
            null == n && (n = Df().touches);
    ...
    var Zh = function (t, n, e) {
        ...
        xp = function (t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, up(l[h], n, e, h, l, kn(a, e)));
    ...
    var td = [null],
        nd = function (t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i)
                    if ((e = i[r]).state > tp && e.name === n) return new Kn([[t]], td, n, +r)
            }
            return null
        },
        ed = function (t) {
        ...
        hv = function (t) {
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < d; ++e)
                    for (var i, o, c, s, l, h, p, v = 0; v < r; ++v) i = t[v], o = i.source, c = i.target, s = c.x + c.vx - o.x - o.vx || Zd(), l = c.y + c.vy - o.y - o.vy || Zd(), h = Math.sqrt(s * s + l * l), h = (h - a[v]) / h * n * u[v], s *= h, l *= h, c.vx -= s * (p = f[v]), c.vy -= l * p, o.vx += s * (p = 1 - p), o.vy += l * p
            }
            ...
            function n(t) {
                function n(t) {
                    ...
                    if ("c" === d) x = g(t) + x, t = "";
                        ...
                        t = +t;
                        var b = t < 0;
                        if (t = g(Math.abs(t), p), b && 0 == +t && (b = !1), m = (b ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + m, x = x + ("s" === d ? Cv[8 + fv / 3] : "") + (b && "(" === c ? ")" : ""), y)
        ...
        lineEnd: function () {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var r = Bc(t), i = Bc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
        ...
        triangles: function () {
            ...
            return this.cells.forEach(function (e, r) {
                if (o = (i = e.halfedges).length)
                    for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o;) u = f, s = n[i[c]], f = s.left === a ? s.right : s.left, u && f && r < u.index && r < f.index && Ms(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }), t
        },
        links: function () {
