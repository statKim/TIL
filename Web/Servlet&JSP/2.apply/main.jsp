...
<!-- PIE START -->
    ...
    <script type="text/javascript">
      ...
      //end body 태그가 실행시 자동 실행되는 구글 함수
      //google.charts.setOnLoadCallback(drawChart);
		
      //응답 완료시 응답된 데이터값으로 차트를 그리는 실제 함수
      //비동기 요청 -> controller -> DAO -> db -> DAO -> ArrayList 두개를 Controller에 반환
      // -> 요청 객체에 저장 -> 이 요청 객체들을 차트에 출력될 수 있게 출력 로직 완성(printView.jsp)
