...
public class JavaPython extends HttpServlet {
	 protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	        ...
	        try {
	            Process p = Runtime.getRuntime().exec("python C:\\ITStudy\\4.python\\price.py");
	            p.waitFor();
	             ...
	             */
	            BufferedReader in 
	            = new BufferedReader(new FileReader("C:\\ITStudy\\4.python\\dataSet\\price.csv"));
	            ...
	            //out.println(buf);
	            req.setAttribute("data", buf.toString()); //StringBuffer의 데이터를 문자열로 변환 및 저장
	            url = "priceView.jsp";
	        } catch (Exception e) {
	            e.printStackTrace();
	            req.setAttribute("error.Msg", "죄송합니다 재요청해주십시오");
	        }
